...
-- NOTE: There's always a completion item selected by default, you may want to enable no select by setting `"suggest.noselect": true` in your configuration file
-- NOTE: Use command ':verbose imap <tab>' to make sure Tab is not mapped by other plugins before putting this into your config
...
keyset("n", "<leader>la", "<Plug>(coc-codeaction-cursor)", opts)
-- Remap keys for apply source code actions for current file.
keyset("n", "<leader>la", "<Plug>(coc-codeaction-source)", opts)
